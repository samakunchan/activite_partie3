...
class AdvertController extends Controller
{
    ...
    public function purgeDaysAction($days)
    {
        $app = $this->container->get('oc_platform.purger.advert');
        $res = $app->dateToPurge($days);
        $em = $this->getDoctrine()->getManager();
        $em->getRepository('OCPlatformBundle:Advert')->myFindDays($res);
