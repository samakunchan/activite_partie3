...
class appDevDebugProjectContainer extends Container
{
    ...
    protected function getDoctrine_Dbal_DefaultConnectionService()
    {
        ...
        return $this->services['doctrine.dbal.default_connection'] = $this->get('doctrine.dbal.connection_factory')->createConnection(array('driver' => 'pdo_mysql', 'host' => '127.0.0.1', 'port' => NULL, 'dbname' => 'symfony1', 'user' => 'root', 'password' => NULL, 'charset' => 'UTF8', 'driverOptions' => array(), 'defaultTableOptions' => array()), $b, $d, array());
    }
    ...
    protected function getDoctrineCache_Providers_Doctrine_Orm_DefaultMetadataCacheService()
    {
        ...
        $instance->setNamespace('sf2orm_default_ac33e01e16d78364b5f01bcd987840eefd4121d2928ced2fbd3bd507d6875d6f');
     ...
     * This method always returns the same instance of the service.
     *
     * @return \OC\PlatformBundle\Purge\OCPurge A OC\PlatformBundle\Purge\OCPurge instance.
     */
    protected function getOcPlatform_Purger_AdvertService()
    {
        return $this->services['oc_platform.purger.advert'] = new \OC\PlatformBundle\Purge\OCPurge();
    }
    ...
    {
        $this->services['security.authentication.manager'] = $instance = new \Symfony\Component\Security\Core\Authentication\AuthenticationProviderManager(array(0 => new \Symfony\Component\Security\Core\Authentication\Provider\AnonymousAuthenticationProvider('5af9b9054f74d0.34864663')), true);
