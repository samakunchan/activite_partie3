...
class AdvertSkill extends \OC\PlatformBundle\Entity\AdvertSkill implements \Doctrine\ORM\Proxy\Proxy
{
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', '' . "\0" . 'OC\\PlatformBundle\\Entity\\AdvertSkill' . "\0" . 'id', '' . "\0" . 'OC\\PlatformBundle\\Entity\\AdvertSkill' . "\0" . 'level', '' . "\0" . 'OC\\PlatformBundle\\Entity\\AdvertSkill' . "\0" . 'advert', '' . "\0" . 'OC\\PlatformBundle\\Entity\\AdvertSkill' . "\0" . 'skill'];
        }
